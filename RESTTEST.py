...
try:
    headers_invalid_token = headers.copy()
    headers_invalid_token['Authorization'] = 'Bearer <INVALID_ACCESS_TOKEN>'
    response = requests.post(url, json=payload, headers=headers_invalid_token)
...
try:
    headers_no_token = headers.copy()
    headers_no_token.pop('Authorization', None)
    response = requests.post(url, json=payload, headers=headers_no_token)
...
try:
    ...
    response = requests.post(url, json=payload_invalid, headers=headers)
...
try:
    ...
    response = requests.post(url, json=payload_missing_field, headers=headers)
...
try:
    response = requests.post('http://invalid.url', json=payload, headers=headers)
...
try:
    ...
    response = requests.post(url, json=payload_malicious, headers=headers)
...
try:
    ...
    response = requests.post(url, json=payload_padded, headers=headers)
...
try:
    ...
    response = requests.post(url, json=payload_truncated, headers=headers)
...
try:
    headers_invalid_token = headers.copy()
    headers_invalid_token['Authorization'] = 'Bearer <INVALID_ACCESS_TOKEN>'
    response = requests.put(url, json=payload, headers=headers_invalid_token)
...
try:
    headers_no_token = headers.copy()
    headers_no_token.pop('Authorization', None)
    response = requests.put(url, json=payload, headers=headers_no_token)
...
try:
    payload_invalid = {'invalid_key': 'invalid_value'}
    response = requests.put(url, json=payload_invalid, headers=headers)
...
try:
    payload_missing_field = {'key1': 'value1'}
    response = requests.put(url, json=payload_missing_field, headers=headers)
